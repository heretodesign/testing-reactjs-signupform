                    ...
                    <div className="column is-one-quarter">
                      <div className="field">
                        <div className="control">
                          <Link to="/" className="button is-info is-fullwidth" id="noticeList">List of Participants</Link>
                        </div>
                      </div>
                    </div>
                    <div className="column is-one-quarter">
                      <div className="field">
                        <div className="control">
                          {/*<Link to="/pages/detailpage" className="button is-info is-fullwidth" id="noticeList"></Link>*/}
                        </div>
                      </div>
                    </div>
                    <div className="column is-one-quarter">
